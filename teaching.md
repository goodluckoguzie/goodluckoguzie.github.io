...
I believe in combining cutting-edge research with practical application. My courses integrate real-world AI and robotics examples, preparing students for both academic and industry careers. With over 13 years of programming and teaching experience, I specialize in Python, OOP, machine learning, and various fields of computer science.
...
Comprehensive progressive teaching modules covering full-stack web development:

<ul>
<li><strong>Part A:</strong> Database Design and Setup</li>
<li><strong>Part B:</strong> Backend Development with Node.js/Express</li>
<li><strong>Part C:</strong> RESTful API Development</li>
<li><strong>Part D:</strong> Frontend Development with React</li>
<li><strong>Part E:</strong> Integration and Testing</li>
<li><strong>Part F:</strong> Advanced Features and Deployment</li>
</ul>

<p>These modules have been successfully used in undergraduate and postgraduate courses and are available for adoption by other institutions.</p>
...
<li>Expertise in both face-to-face and online/hybrid delivery methods</li>
