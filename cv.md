...
**Supervisors:** Dr. Luis J. Manso, Prof. Dr. Aniko Ekart

**Key Contributions:**
1. Predictive World Models (2StepAhead, MASPM) for multi-step ahead predictions
2. Cosine-Gated LSTM (CGLSTM) architecture for improved sequential learning
3. Adaptive Prediction Horizons that dynamically adjust based on environmental complexity
...
Focus on automation systems, control engineering, and robotics applications.
...
Foundation in electrical engineering, electronics, and embedded systems.
...
- **Engineering and Mathematics Department Representative** (Sep 2018 - Nov 2020)
- **Automation Control and Robotics Representative** (Jan 2018 - Jun 2019)
- **International Students' Officer** (May 2018 - May 2019)
- **NUS Sheffield Hallam University Delegate** (Nov 2018 - Dec 2019)
