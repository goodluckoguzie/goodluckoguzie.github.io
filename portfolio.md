      ...
      <div class="carousel-slide active" data-slide="0">
        <div class="carousel-card">
          ...
          <div class="card-content">
            <div class="card-text">
              <p class="project-description">I developed this simple environment where a ball falls and bounces. The floor position is not included in the observation space. Can the model learn to predict when the ball will bounce?</p>
